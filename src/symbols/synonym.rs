...
impl SynonymTable {
    ...
    pub fn resolve_instruction(&self, phrase: &str) -> Option<Instruction> {
        ...
        match word.as_str() {
            ...
            | "investigate" | "study" | "review" | "discuss" => Some(Instruction::Analyze),
            "generate" | "create" | "produce" | "write" | "compose" | "draft" | "build"
            | "make" | "construct" => Some(Instruction::Generate),
            ...
            "search" | "find" | "look up" | "lookup" | "locate" | "discover" => {
                Some(Instruction::Search)
            }
            "transform" | "reshape" | "reformat" | "restructure" | "rework" => {
